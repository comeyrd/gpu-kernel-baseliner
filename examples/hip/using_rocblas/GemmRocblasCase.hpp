...
template <typename T>
class RocBlasGemmCase : public Baseliner::ICase<Baseliner::Hardware::HipBackend> {
public:
  auto name() -> std::string override {
    return "RocBlasGemm_" + std::string(typeid(T).name());
  }

  void setup(std::shared_ptr<typename Baseliner::Hardware::HipBackend::stream_t> stream) override {
  ...
  void run_case(std::shared_ptr<typename Baseliner::Hardware::HipBackend::stream_t> stream) override {
  ...
  void teardown(std::shared_ptr<typename Baseliner::Hardware::HipBackend::stream_t> stream) override {
  ...
  void reset_case(std::shared_ptr<typename Baseliner::Hardware::HipBackend::stream_t> stream) override {
